...
if __name__ == '__main__':
	""" compute the diffusion fingerprints (arguments: <association_data_sample_dir> <stats_data_dir> <g_filename> <ncpus> <ppr_filename>) """
	...
	for i in range(10):
		...
		jobs = [(p, js.submit(get_ppr,(g,stats_dir,p,iw,),(GraphUtils,MatrixUtils,),('igraph','cPickle','utils','numpy','numpy.linalg',))) for p in fns]
		for p, j in jobs:
			p_ppr[p.replace('.p','')] = j()
